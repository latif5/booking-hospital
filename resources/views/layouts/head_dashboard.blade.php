...
-->
    ...
    <!-- jQuery peity -->
    <script src="{{URL::asset('plugins/bower_components/peity/jquery.peity.min.js')}}"></script>
    <script src="{{URL::asset('plugins/bower_components/peity/jquery.peity.init.js')}}"></script>
